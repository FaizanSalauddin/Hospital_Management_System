    ...
    <AnimatePresence mode="wait">
      {isAdminRoute ? (
        <Routes location={location} key={location.pathname}>
          ...
          <Route
            path="/admin/ipd-bed-allocation"
            element={<AdminIPDBedManagement />}
          />
        </Routes>
      ) : (
        <Layout>
          <Routes location={location} key={location.pathname}>
            ...
            <Route
              path="/store"
              element={<Store addToCart={addToCart} cart={cart} />}
            />
            <Route
              path="/cart"
              element={
            ...
            <Route
              path="/facilities/health-packages/:id"
              element={<HealthPackageDetails />}
            />
            ...
            <Route
              ...
              element={<SpecialtyCardiology />}
            />
            <Route
              path="/specialty/neurology"
              element={<SpecialtyNeurology />}
            />
            <Route
              path="/specialty/orthopedics"
              element={<SpecialtyOrthopedics />}
            />
            <Route
              path="/specialty/oncology"
              element={<SpecialtyOncology />}
            />
          </Routes>
        </Layout>
      )}
